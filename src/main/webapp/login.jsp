...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">FORESTY MGT SYS</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="user.html">User</a>
            </li>
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          ...
          <div class="intro-heading text-uppercase"><h1>FOREST MANAGEMENT SYSTEM(S)</h1></div>
    ...
    <section id="services">
      <div class="container">
       ...
       <div style="margin-left:375px;margin-top:-50px;"><h1>FOREST MANAGEMENT SYSTEM(S)</h1><br><h1>Customer Login</h1></div>
...
<div style="padding-top:50px;margin-left:70px;"><font size="5">User Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;<input type="text"name="name"></font></div><br><br>
<div style="margin-left:70px;"><font size="5">Password&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;<input type="text"name="phone"></font></div>
